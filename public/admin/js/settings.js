var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="'+basePath+'/public/admin/css/theme-default.css"><img src="'+basePath+'/public/admin/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="'+basePath+'/public/admin/css/theme-brown.css"><img src="'+basePath+'/public/admin/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="'+basePath+'/public/admin/css/theme-blue.css"><img src="'+basePath+'/public/admin/img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="'+basePath+'/public/admin/css/theme-white.css"><img src="'+basePath+'/public/admin/img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="'+basePath+'/public/admin/css/theme-black.css"><img src="'+basePath+'/public/admin/img/themes/black.jpg"/></a>'
        +'</div>'
