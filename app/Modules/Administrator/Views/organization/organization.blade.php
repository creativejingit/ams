						...
						<div class="col-xl-6 col-lg-5 col-md-4 col-sm-12">
							<ul class="breadcrumb breadcrumb-style">
								...
								<li class="breadcrumb-item active">
									<a href="{{url('organization/view-organization')}}"> Organization </a> 
									...
									<div class="row clearfix demo-icon-container">
										<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
											<div class="demo-google-material-icon">
												<a href="{{url('organization/add-organization')}}">
										...
										<tbody>
												...
												<tr id="trow_{{$id}}">
													...
													<td class="" style="width: 12%;">
															...
															<a href="{{url('organization/edit/'.$td->organization_id)}}"  data-row="trow_{{$id}}">
															...
															<button class="btn btn-info waves-effect js-sweetalert"
																		...
																		data-id="{{$td->organization_id}}" 
																		data-url="{{url('organization/delete')}}"  
																		data-row="trow_{{$id}}"
