							...
							<ul class="breadcrumb breadcrumb-style">
								<li class="breadcrumb-item 	bcrumb-1">
									...
									<li class="breadcrumb-item active">
										<a href="{{url('package/view-package')}}"> CLIENT </a> 
									...
									<div class="row clearfix demo-icon-container">
										<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
											<div class="demo-google-material-icon">
												<a href="{{url('admin/add-client-creation')}}">
										...
										<tbody>
												...
												<tr id="trow_{{$id}}">
													...
													<td class="" style="width: 12%;">
															...
															<a href="{{url('admin/client-creation/edit/'.$td->client_id)}}"  data-row="trow_{{$id}}">
															...
															<button class="btn btn-info waves-effect js-sweetalert"
																		...
																		data-id="{{$td->client_id}}" 
																		data-url="{{url('admin/client-creation/delete')}}"  
																		data-row="trow_{{$id}}"
