			...
			<div class="container-fluid">			
							...
							<ul class="breadcrumb breadcrumb-style">
								<li class="breadcrumb-item 	bcrumb-1">
									...
									<li class="breadcrumb-item active">
										<a href="{{url('package/view-package')}}"> Company Creation </a> 
				...
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="card">
							<div class="header">
								<h2><strong>Company Creation</strong></h2>
								<div class="header-dropdown m-r--5">
									<div class="row clearfix demo-icon-container">
										<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
											<div class="demo-google-material-icon">
												<a href="{{url('admin/add-company-creation')}}">
								...
								<div class="table-responsive">
									...
									<table id="tableExport" class="display table  table-bordered table-striped table-hover table-checkable order-column m-t-20 width-per-500">
										...
										<tbody>
												...
												@php($id = 1)
												@foreach($company_creation as $td)
												<tr id="trow_{{$id}}">
													...
													<td class="" style="width: 12%;">
															...
															<a href="{{url('admin/company-creation/edit/'.$td->company_id)}}"  data-row="trow_{{$id}}">
															...
															<button class="btn btn-info waves-effect js-sweetalert"
																		...
																		data-id="{{$td->company_id}}" 
																		data-url="{{url('admin/company-creation/delete')}}"  
																		data-row="trow_{{$id}}"
